...
if __name__ == "__main__":
	...
	train_loader = torch.utils.data.DataLoader(list(zip(x_train,y_train)),batch_size = 20,shuffle = True)
	validation_loader = torch.utils.data.DataLoader(list(zip(x_train,y_train)),batch_size = 20,shuffle = True)
