...
if __name__ == "__main__":
	...
	max_count = 0
	for entry in os.listdir("models_weight_gru"):
		num = int(entry.split(".")[0].split("_")[1])
		if num > max_count:
			max_count = num

	#save model	
	torch.save(model_lstm_gbrbm.state_dict(),"models_weight_gru/gru-gbrbm_{}.pt".format(max_count+1))
