        ...
        for HIDDEN_SIZE in hidden_sizes:
            for BATCH_SIZE in batch_sizes:
                ...
                if MODEL == "lstm_gbrbm":
                    ...
                    torch.save(model_lstm_gbrbm.state_dict(),"./final_project/lstm_gbrbm/{}/lstm_gbrbm_W{}_H{}_B{}.pt"
                               .format(DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
                    
                    fig = plt.figure()
                    plt.title("Train lstm_gbrbm_W{}_H{}_B{}"
                               .format(DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
                ...
                if MODEL == "gru_gbrbm":
                    ...
                    torch.save(model_gru_gbrbm.state_dict(),"./final_project/gru_gbrbm/{}/gru_gbrbm_W{}_H{}_B{}.pt"
                               .format(DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
                    
                    fig = plt.figure()
                    plt.title("Train gru_gbrbm_W{}_H{}_B{}"
                               .format(DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
                    ax1 = fig.add_subplot(311)
                    ax2 = fig.add_subplot(312)
                    ax3 = fig.add_subplot(313)
                    ...
                    plt.savefig("./final_project/gru_gbrbm/{}/train_error_W{}_H{}_B{}.png"
                               .format(DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
                ...
                results_path = "./final_project/{}/{}/pd_results_W{}_H{}_B{}.xlsx"\
                .format(MODEL,DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE)
                ...
                plt.savefig("./final_project/{}/{}/test_error_W{}_H{}_B{}.png"
                               .format(MODEL,DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
                ...
                plt.savefig("./final_project/{}/{}/plot_test_W{}_H{}_B{}.png"
                               .format(MODEL,DSET_NAME.split("^N225_")[1].split(".")[0],WINDOW_SIZE,HIDDEN_SIZE,BATCH_SIZE))
